...
public class StartUpCommandsFragment extends RecyclerViewFragment implements CardViewItem.DCardView.OnDCardListener {
    ...
    public void listcommands () {
        ...
        if (commandItems.size() > 0) {
            ...
            for (int i = 0; i < commandItems.size(); i++) {
                ...
                mStartUpCommandsDelete = new CardViewItem.DCardView();
                mStartUpCommandsDelete.setTitle(R.string.startup_commands_none);
    ...
    public void onClick(CardViewItem.DCardView dCardView) {
        ...
        if (dCardView == mStartUpCommandsDelete) {
            ...
            builder.setMessage(R.string.startup_commands_delete_all).setPositiveButton(R.string.startup_commands_delete_all_yes, dialogClickListener)
                    .setNegativeButton(R.string.startup_commands_delete_all_no, dialogClickListener).show();
        }
